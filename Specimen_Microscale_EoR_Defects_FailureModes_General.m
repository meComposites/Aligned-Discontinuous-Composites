...
function Specimen_dataset = Specimen_Microscale_EoR_Defects_FailureModes_General(repeat_counter,Composite_index,lf,lspecimen,n_rows0,n_columns0,pc,pInterface,pcFailed,pg,pgPartial,pgFailed,misalignment_switch,rng_switch,failure_modes_switch,parallelisation_flag)
