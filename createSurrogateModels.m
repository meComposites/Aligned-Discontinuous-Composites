function createSurrogateModels(batch_index,defect_case,exploration_ratio)

batch_index=1+(batch_index-1)*40;
num_obj_function_evaluations=0;
num_slices=40;
