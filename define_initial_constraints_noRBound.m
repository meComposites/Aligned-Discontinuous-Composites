function initial_constraints=define_initial_constraints_hybrid(e_constraint_name,e_constraint_min,n_e_constraint_slices,e_constraint_max,batch_index,defect_case)
