function [num_files]=gather_MO_pareto_variability_inputs(defect_case,gather_flag)
...
switch gather_flag
    case 'gather'
        save(['matlab_scripts-second_pass/' defect_case '_MO_pareto_variability_inputs.mat'],'num_files','Filename','MO_case','Carbon_fibre','Glass_fibre','Vc','lf','SmAvg','G','GiicmAvg',...
    ...
    otherwise
        save(['results-second_pass/variabilityParetoFronts/' defect_case '_MO_pareto_variability_inputs.mat'],'num_files','Filename','MO_case','Carbon_fibre','Glass_fibre','Vc','lf','SmAvg','G','GiicmAvg',...
        'pc_fragmented','pc_vacancy','pg_fragmented','pg_vacancy','p_interface','misalignment_case','Initial_stiffness','Ultimate_strain','Pseudo_ductile_strain','Ultimate_strength','Yield_strength','-v7.3');
end
end
